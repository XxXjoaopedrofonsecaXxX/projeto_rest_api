...
public class Main {
	...
	public static void main(String[] args) {
		...
		airplane1.setAirline(redLine.getName()); // Defina a companhia aérea para o avião
		...
		airplane2.setAirline(redLine.getName()); // Defina a companhia aérea para o avião
        ...
        airplane3.setAirline(blueLine.getName()); // Defina a companhia aérea para o avião
        ...
        airplane4.setAirline(blueLine.getName()); // Defina a companhia aérea para o avião
        ...
        airplane5.setAirline(greenLine.getName()); // Defina a companhia aérea para o avião
        ...
        airplane6.setAirline(greenLine.getName()); // Defina a companhia aérea para o avião
